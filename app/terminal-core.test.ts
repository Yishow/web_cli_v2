...
test("uses the built-in wasm url for the default core", () => {
...
test("requires a loaded ghostty core instead of passing ghostty wasmUrl to Terminal", () => {
...
test("loads ghostty through GhosttyCore options rather than Terminal wasmUrl", () => {
